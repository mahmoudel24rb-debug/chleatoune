...
with sync_playwright() as p:
    ...
    # le suivi vit désormais dans le LIVRE DE QUÊTES (bouton 📖 / touche J)
    page.keyboard.press("KeyJ")
    page.wait_for_timeout(400)
    verifier("livre de quêtes (J) : chapitre 1", "CHAPITRE 1" in page.locator("#modal").inner_text())
    ...
    page.keyboard.press("KeyJ")
    page.wait_for_timeout(400)
    verifier("étape collecter active", "COLLECTER 150" in page.locator("#modal").inner_text())
    page.keyboard.press("Escape")
    page.wait_for_timeout(300)
    ...
    page.keyboard.press("KeyJ")
    page.wait_for_timeout(400)
    verifier("collecte validée → retour Brioche", "REVENIR" in page.locator("#modal").inner_text())
    page.keyboard.press("Escape")
    page.wait_for_timeout(300)
    page.keyboard.press("KeyE")
